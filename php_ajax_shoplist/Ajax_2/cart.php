...
<?php
    try{
        ...
        $sql = "select *
                from shop_product p right join shop_chart c 
                on p.id = c.productid where userid=?";
...
?>
            <tr id="tr-<?php echo $product['productid'] ?>" class="products">
              ...
              <td align="center" bgcolor="#ffffff">￥<span id="p-<?php echo $product['productid'] ?>"><?php echo $product['price'] ?></span>元</td>
              <td align="center" bgcolor="#ffffff">
                <input type="text" name="goods_number" value="<?php echo $product['num'] ?>" size="4" class="inputBg" style="text-align:center " id="product-<?php echo $product['productid'] ?>"
                       onblur="Num(<?php echo $product['productid'] ?>,this.value)">
               </td>
              <td align="center" bgcolor="#ffffff">￥<span id="total-<?php echo $product['productid'] ?>"><?php echo $product['num']*$product['price'] ?></span>元</td>
              <td align="center" bgcolor="#ffffff">
                <a href="javascript:delPro(<?php echo $product['productid'] ?>);" class="f6">删除</a>
              </td>
            </tr>
<?php
...
?>
          ...
          <table width="99%" align="center" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
            <tbody><tr>
              <td bgcolor="#ffffff" class="retotal">
...
<div id="footer" style="background:none;"> 
 <div style="height:1px; width:1px; overflow:hidden;"> <a href="http://www.imooc.com/" target="_blank" style=" font-family:Verdana; font-size:11px;">Powered&nbsp;by&nbsp;<strong><span style="color: #3366FF">kelly</span>&nbsp;<span style="color: #FF9966">v1.0</span></strong></a>&nbsp;<a href="" target="_blank">&nbsp;&nbsp;Licensed</a><br></div>
</div>
...
<p class="fooCorpy">
  ...
  <br>
<a href="http://www.imooc.com/" target="_blank" style=" font-family:Verdana; font-size:11px;">Powered&nbsp;by&nbsp;<strong><span style="color: #3366FF"></span>&nbsp;<span style="color: #FF9966">v1.0</span></strong></a>&nbsp;<a href="" target="_blank">&nbsp;&nbsp;Licensed</a><br>
