...
<script type="text/javascript">
	mypicBg();
     ...
     <form action="" method="post" name="" id="">
      ...
      <strong>上架时间：</strong><?php echo $data['createtime'] ?>
       </dd>
       </li>
              <li class="clearfix">
       <dd>
...
<div id="footer" style="background:none;"> 
 <div style="height:1px; width:1px; overflow:hidden;"> <a href="" target="_blank" style=" font-family:Verdana; font-size:11px;">Powered&nbsp;by&nbsp;<strong><span style="color: #3366FF">kelly</span>&nbsp;<span style="color: #FF9966">v1.0</span></strong></a>&nbsp;<a href="" target="_blank">&nbsp;&nbsp;Licensed</a><br></div>
</div>
